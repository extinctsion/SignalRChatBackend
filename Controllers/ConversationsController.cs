...
namespace ChatBackend.Controllers
{
    ...
    public class AddMemberDto
    {
        ...
        public ChatBackend.Models.ConversationRole Role { get; set; } = ChatBackend.Models.ConversationRole.Member;
    }
    
    public class UpdateRoleDto
    {
        public ChatBackend.Models.ConversationRole Role { get; set; }
    }
}
